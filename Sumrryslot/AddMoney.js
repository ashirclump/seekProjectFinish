    ...
    <>
      <View>
        ...
        <View style={{flexDirection: 'row', left: 20, marginTop: 40}}>
          ...
          />
          <Text
            style={{fontSize: 16, color: 'black', fontWeight: '600', left: 20}}>
            Debit % Credit Cards
          </Text>
        ...
        <View style={{flexDirection: 'row', left: 20, marginTop: 20}}>
          ...
          <Image style={{left: 240}} source={require('../assets/upi.png')} />
        </View>
        ...
        <View
          style={{
            ...
            padding: 10,
            alignItems: 'center',
            backgroundColor: 'rgba(245, 196, 67, 1)',
            marginTop: 50,
            marginHorizontal: 20,
          }}>
        ...
        <TouchableOpacity
          onPress={() => navigation.navigate('Sucessfullbokkking')}>
          <View
            style={{
              borderRadius: 10,
              padding: 20,
