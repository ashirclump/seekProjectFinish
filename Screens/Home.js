...
//         message: item.price,
//         bigText: item.name+ " is one of the largest and most beatiful cities in " + item.price,
//         color: "red",
//         id: index
//     });
//   }
        ...
        {/* <View style={{marginHorizontal: 20, bottom: 22}}> */}
          ...
          <View style={{marginTop: 30}}>
            ...
            <FlatList
              ...
              renderItem={({item}) => (
                // console.log('categories',item._id)
                <TouchableOpacity
                
                  onPress={() => [
                    console.log('category', item.name)
                  ,navigation.navigate('Salonforwomen',{head: item.name,id:item._id })
                  ]}>
